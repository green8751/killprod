...
function KP_array_builder(override)
    if override == nil then
        default = not settings.global["KP-override-Violence-values"].value
    ...
    if default == true then
        ...
        if checkmod("space-age", mode) then
            ...
            wriggler = {{"small-wriggler-pentapod", 2},{"medium-wriggler-pentapod", 6.5}, {"big-wriggler-pentapod", 12.5}}
            premature = {{"small-wriggler-pentapod-premature", 0.2},{"medium-wriggler-pentapod-premature", 0.65}, {"big-wriggler-pentapod-premature", 1.25}}
            raft = {{"gleba-spawner", 20},{"gleba-spawner-small", 7}}
        end
    else
        ...
        if script.active_mods["space-age"] then
            ...
            wriggler = {{"small-wriggler-pentapod", settings.global["KP-small-wriggler-pentapod"].value},{"medium-wriggler-pentapod", settings.global["KP-medium-wriggler-pentapod"].value},{"big-wriggler-pentapod", settings.global["KP-big-wriggler-pentapod"].value}}
            premature = {{"small-wriggler-pentapod-premature", settings.global["KP-small-wriggler-pentapod-premature"]},{"medium-wriggler-pentapod-premature", settings.global["KP-medium-wriggler-pentapod-premature"]}, {"big-wriggler-pentapod-premature", settings.global["KP-big-wriggler-pentapod-premature"]}}
            raft = {{"gleba-spawner", settings.global["KP-gleba-spawner"].value},{"gleba-spawner-small", settings.global["KP-gleba-spawner-spawn"].value}}
        end
    end
    ...
    if checkmod("space-age", mode) then
        ...
        final_array["wriggler"] = wriggler
        final_array["premature"] = premature
        final_array["raft"] = raft
    end
    return final_array
end
